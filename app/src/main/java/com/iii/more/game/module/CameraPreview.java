...
public class CameraPreview extends TextureView
{
    ...
    private void setUpCameraOutputs(int width, int height)
    {
        ...
        try
        {
            for (String cameraId : manager.getCameraIdList())
            {
                ...
                //Size largest = getMaxSize(map.getOutputSizes(SurfaceHolder.class));
                ...
                switch (displayRotation)
                {
                    ...
                    case Surface.ROTATION_270:
                        ...
                        break;
                    default:
                        Logs.showTrace("Display rotation is invalid: " + displayRotation);
                }
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth, int textureViewHeight, int maxWidth, int maxHeight, Size aspectRatio)
    {
        ...
        {
            Logs.showTrace("Couldn't find any suitable preview size");
            return choices[0];
        }
    }
        ...
        try
        {
            ...
            for (String cameraId : cameraManager.getCameraIdList())
            {
                ...
                if (currentCameraId == CameraCharacteristics.LENS_FACING_BACK && characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics.LENS_FACING_FRONT)
                {
                    ...
                    mCameraDevice.close();
                    openCamera(maxSize.getWidth(), maxSize.getHeight());
                    break;
                }
                else if (currentCameraId == CameraCharacteristics.LENS_FACING_FRONT && characteristics.get(CameraCharacteristics.LENS_FACING) == CameraCharacteristics
                    .LENS_FACING_BACK)
                {
                    //后置转前置

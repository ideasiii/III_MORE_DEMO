...
import com.iii.more.power.PowerSaving;
    ...
    FaceEmotionEventListener, CockpitSensorEventListener
{
    ...
    protected void onDestroy()
    {
        ...
        PowerSaving.releaseScreenAlwaysOn(this);
        super.onDestroy();
    }
    ...
    protected void onStart()
    {
        ...
        {
            boolean isActive = PowerSaving.setOnScreenAlwaysOn(this);
            if (!isActive)
            {
                Logs.showError("[MainActivity] something ERROR while setOnScreenAlwaysOn");
            }
        }

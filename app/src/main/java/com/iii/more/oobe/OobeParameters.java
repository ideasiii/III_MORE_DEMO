...
public abstract class OobeParameters
{
    ...
    public static final String LOGIC_OOBE = "{" +
            ...
            "{\"state\":4,\"tts\":\"謝謝你的條紋魚\",\"png\":\"OCTOBO_Expressions-37.png\",\"wait\":2000}," +
            "{\"state\":5,\"tts\":\"xx好喜歡oo喔！每天早上，你只要抱抱我搖一搖，我會為你唱首歌；拿我的手做刷牙動作，我會帶你刷刷牙；我們可以一起吃飯；拍拍我的頭，還能一起睡覺！以後我們每天都要一起玩喔！\",\"movie\":\"edubot/video/abcfun/01.mp4\"}]" +
            "}";
